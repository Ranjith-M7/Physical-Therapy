              ...
              <div className="row justify-content-center mb-4">
                <div className="col-md-10 text-center">
                  <h1 data-aos="fade-up" className="mb-5">
                    Our <span className="typed-words" />
                  </h1>
                </div>
              </div>
            </div>
          ...
          <div className="row">
                  ...
                  <div className="h-entry">
                    ...
                    <div className="h-entry-inner">
                      <h2 className="font-size-regular">
                        <a href="blog-single.html">
                          Blog post title for Physical Therapy
                        </a>
                      </h2>
                      <div className="meta mb-4">
                        by <a href="blog-single.html">Jeff Sheldon</a>{" "}
                        <span className="mx-2">•</span> May 5th, 2019
                      </div>
                      <p>
            ...
            <div className="col-md-3 ml-auto">
              ...
              <div className="mb-5">
                ...
                <ul className="list-unstyled post-lists">
                  <li className="mb-2">
                    <a href="#">Hannah</a> <em>in</em>{" "}
                    <a href="#">Lorem ipsum dolor sit amet</a>
                  </li>
                  <li className="mb-2">
                    <a href="#">Roger</a> <em>in</em>{" "}
                    <a href="#">Quaerat rerum voluptatibus veritatis</a>
                  </li>
                  <li className="mb-2">
                    <a href="#">Hannah</a> <em>in</em>{" "}
